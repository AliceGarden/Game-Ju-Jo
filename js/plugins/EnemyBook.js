...
(function() {
	...
	Scene_EnemyBook.AFS.Window_MenuCommand_addOriginalCommands =
		Window_MenuCommand.prototype.addOriginalCommands;
	Window_MenuCommand.prototype.addOriginalCommands = function() {
		Scene_EnemyBook.AFS.Window_MenuCommand_addOriginalCommands.call(this);
		if (showFpMenu) {
			if (fpMenuSwitch === 0) {
				this.addCommand(fpTitle, 'Book', true);
