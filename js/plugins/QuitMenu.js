...
if (Utils.isNwjs()) {
    if (!Utils.isMobileDevice()) {
        ...
        if (typeof(Window_TitleCommand.prototype._quitbuttonreplace_old_makeCommandList) == "undefined") {
            Window_TitleCommand.prototype._quitbuttonreplace_old_makeCommandList = Window_TitleCommand.prototype.makeCommandList;
        }
        ...
        if (typeof(Scene_Title.prototype._quitbuttonreplace_old_createCommandWindow) == "undefined") {
            Scene_Title.prototype._quitbuttonreplace_old_createCommandWindow = Scene_Title.prototype.createCommandWindow;
        }
